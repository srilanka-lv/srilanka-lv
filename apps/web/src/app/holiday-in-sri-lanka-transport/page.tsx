...
import { PAGE_INFO_TRANSPORT_SLUG } from '@/features/sanity/constants/pages-slugs';
...
export default function HolidayInSriLankaTransportPage() {
  const href = `/${PAGE_INFO_TRANSPORT_SLUG}`;
