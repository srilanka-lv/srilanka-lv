...
const staticPages: StaticPage[] = [
  ...
  toStaticPage(
    PAGES.LV.PRODUCTS_CONSULTATION,
    `/${PAGES.LV.PRODUCTS}/${PAGES.LV.PRODUCTS_CONSULTATION}`,
  ),
  toStaticPage(
    PAGES.LV.PRODUCTS_HOLIDAY_PLAN,
    `/${PAGES.LV.PRODUCTS}/${PAGES.LV.PRODUCTS_HOLIDAY_PLAN}`,
  ),
